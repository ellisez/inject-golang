...
func genWebUtilsFile(ctx *model.Ctx, dir string) error {
	...
	genWebUtilsImportsAst(ctx, astFile)
...
func genWebUtilsImportsAst(ctx *model.Ctx, astFile *ast.File) {
	addImport(astFile, ctx, "", "mime/multipart")
	addImport(astFile, ctx, "", "reflect")
	addImport(astFile, ctx, "", "strconv")
